    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
        <tr>
            <td style="background-color: #279447; padding: 30px; text-align: center;">
                ...
                <h1 style="color: #ffffff; margin: 0; font-size: 20px; font-weight: 700; letter-spacing: 0.5px;">Permohonan Anda Disetujui</h1>
            </td>
        </tr>
        <tr>
            <td style="padding: 40px 40px 30px;">
                <p style="margin: 0 0 24px 0; font-size: 13px; line-height: 1.6; color: #4b5563;">
                    Yth. <strong>{{ $permohonan->nama_pic }}</strong>,<br><br>
                    Selamat, permohonan kunjungan kerja Anda telah <strong>disetujui</strong>. Silakan hadir sesuai tanggal dan agenda yang telah diajukan, serta tunjukkan kode permohonan kepada petugas saat tiba.
                </p>
                ...
                <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; padding: 24px; border-radius: 8px; margin-bottom: 16px; text-align: center;">
                    ...
                    <p style="margin: 0 0 16px 0; font-size: 22px; font-weight: 800; color: #279447; letter-spacing: 1px;">{{ $permohonan->kode }}</p>
                    <span style="display: inline-block; background-color: #e6f4ea; color: #279447; padding: 5px 12px; border-radius: 4px; font-size: 10px; font-weight: 700; letter-spacing: 1px;">DISETUJUI</span>
                </div>

                <div style="background-color: #f8fafc; padding: 20px 24px; border-radius: 8px; margin-bottom: 30px;">
                    <p style="margin: 0 0 16px 0; font-size: 12px; color: #374151;"><strong>Jam Penerimaan Kunjungan:</strong> {{ $permohonan->jam_penerimaan ? $permohonan->jam_penerimaan . ' WIB' : '-' }}</p>
                ...
                <div style="text-align: center;">
                    <a href="{{ url(env('FRONTEND_URL', 'http://localhost:5173') . '/?page=status&kode=' . $permohonan->kode) }}" style="display: inline-block; background-color: #279447; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: 700; font-size: 12px;">Pantau Status Permohonan</a>
                </div>
            </td>
        </tr>
        <tr>

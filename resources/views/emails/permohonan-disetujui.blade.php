        ...
        <tr>
            <td style="padding: 40px 40px 30px;">
                <p style="margin: 0 0 24px 0; font-size: 13.5px; line-height: 1.6; color: #4b5563;">
                    ...
                    Selamat, permohonan kunjungan kerja Anda telah <strong style="color: #1883FF;">disetujui</strong>. Silakan hadir sesuai tanggal dan agenda yang telah diajukan, serta tunjukkan kode permohonan kepada petugas saat tiba.
                </p>
                ...
                <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; padding: 24px; border-radius: 8px; margin-bottom: 16px; text-align: center;">
                    ...
                    <p style="margin: 0 0 16px 0; font-size: 22px; font-weight: 800; color: #1883FF; letter-spacing: 1px;">{{ $permohonan->kode }}</p>
                    <span style="display: inline-block; background-color: #EFF6FF; color: #1883FF; border: 1px solid #C5DBFF; padding: 5px 14px; border-radius: 4px; font-size: 11px; font-weight: 700; letter-spacing: 1px;">DISETUJUI</span>
                </div>
